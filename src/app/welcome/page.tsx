      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-md dark:shadow-neutral-900/50 p-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-neutral-200 mb-6 text-center tracking-tight uppercase">Getting Started</h2>
          ...
          {/* Features Overview */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-neutral-200 mb-6 text-center tracking-tight uppercase">Key Features</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="w-1.5 h-1.5 rounded-full bg-brand-red mr-3 mt-2 shrink-0"></div>
                  <div>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-neutral-200 mb-6 text-center tracking-tight uppercase">Account Categories Guide</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-green-50 dark:bg-green-900/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-green-800 dark:text-green-300 mb-3 underline underline-offset-4 decoration-2 decoration-green-500/30">Assets</h3>
              ...
              <div className="bg-red-50 dark:bg-red-900/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-red-800 dark:text-red-300 mb-3 underline underline-offset-4 decoration-2 decoration-red-500/30">Liabilities</h3>
              ...
              <div className="bg-neutral-50 dark:bg-neutral-800 dark:bg-brand-red/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3 underline underline-offset-4 decoration-2 decoration-brand-red/30">Equity</h3>
          ...
          {/* Operating Notes */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-neutral-200 mb-6 text-center tracking-tight uppercase">Operating Notes</h2>
            <div className="bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700 rounded-3xl p-8">
              <ul className="space-y-4 text-gray-700 dark:text-neutral-300 text-sm font-bold uppercase tracking-widest leading-relaxed">
                <li className="flex items-center">
                  <span className="w-2 h-2 rounded-full bg-brand-red mr-4 shrink-0"></span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200 dark:border-neutral-700">
            <Link
              href="/add-account"
              className="bg-brand-red hover:bg-brand-red-dark text-white px-6 py-3 rounded-md font-medium transition-colors text-center flex-1 uppercase tracking-widest text-[10px] font-black shadow-lg"
            >
              Start by Adding an Account
            </Link>
            <Link
              href="/"
              className="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-md font-medium transition-colors text-center uppercase tracking-widest text-[10px] font-black shadow-lg"
            >
              View Balance Sheet
            </Link>
            <Link
              href="/disclaimer"
              className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-md font-medium transition-colors text-center uppercase tracking-widest text-[10px] font-black shadow-lg"
            >
              Privacy Charter
            </Link>
            <Link
              href="/terms"
              className="bg-neutral-800 hover:bg-neutral-900 text-white px-6 py-3 rounded-md font-medium transition-colors text-center uppercase tracking-widest text-[10px] font-black shadow-lg"
            >
              Legal Terms
            </Link>
          </div>
